...
import 'package:arduinoiot/ui/screen/radial_gauge/utils/flatten_segments.dart';
import 'package:arduinoiot/ui/screen/radial_gauge/utils/lerp_double.dart';
...
class GaugeAxis extends Equatable {
  ...
  static GaugeAxis lerp(GaugeAxis begin, GaugeAxis end, double t) {
    if (begin == null && end == null) {
      ...
      return GaugeAxis(
        degrees: lerpDouble(begin.degrees, end.degrees, t),

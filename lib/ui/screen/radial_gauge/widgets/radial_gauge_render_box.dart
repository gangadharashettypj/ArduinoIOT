...
import 'package:arduinoiot/ui/screen/radial_gauge/utils/apply_aspect_ratio.dart';
import 'package:arduinoiot/ui/screen/radial_gauge/utils/degrees_to_radians.dart';
import 'package:arduinoiot/ui/screen/radial_gauge/utils/get_arc_angle.dart';
import 'package:arduinoiot/ui/screen/radial_gauge/utils/get_point_on_circle.dart';
import 'package:arduinoiot/ui/screen/radial_gauge/utils/get_sagitta.dart';
import 'package:arduinoiot/ui/screen/radial_gauge/utils/rotate_over_origin.dart';
...
class RadialGaugeRenderBox extends RenderShiftedBox {
  ...
  GaugeLayout _computedLayout;
  GaugeAxisDefinition _axisDefinition;
  ...
  void performLayout() {
    ...
    final radiusBasedSize =
        radius != null ? Size(radius * 2, ratios.getHeight(radius * 2)) : null;

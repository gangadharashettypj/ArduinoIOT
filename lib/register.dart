import 'package:arduinoiot/util/auth.dart';
...
class _RegisterState extends State<Register> {
  ...
  @override
  initState() {
    _firstNameInputController = TextEditingController(text: 'dfsgr');
    _lastNameInputController = TextEditingController(text: 'sdgff');
    _emailInputController = TextEditingController(text: 'gs@gmail.com');
    _pwdInputController = TextEditingController(text: '12345678');
    _confirmPwdInputController = TextEditingController(text: '12345678');
    super.initState();
  }
